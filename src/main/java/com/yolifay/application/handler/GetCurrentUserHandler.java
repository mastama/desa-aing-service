...
import com.yolifay.application.exception.AccessUnauthorizedDeniedException;
...
public class GetCurrentUserHandler {
    ...
    public GetCurrentUserCommand handleGetCurrentUser() throws Exception {
    ...
    private Long resolveCurrentUserId() {
        ...
        if (auth == null || !auth.isAuthenticated()) {
            throw new AccessUnauthorizedDeniedException("Unauthenticated");
        }
        ...
        try {
            ...
            throw new AccessUnauthorizedDeniedException("Invalid subject in security context");
        }
    }
}
